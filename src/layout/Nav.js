...
const Nav = () => {
  ...
  return (
    ...
    >
      <div className="container flex flex-wrap justify-between items-center mx-auto nav__container">
        <div className="w-24" style={{width: "70px"}}>
        ...
        <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-lg md:font-medium navbar__menu">
            <li>
              <Link
                to="/"
